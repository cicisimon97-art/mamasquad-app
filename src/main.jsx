...
const styles = {
  ...
  detailHeader: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 16px 12px", paddingTop: "calc(16px + env(safe-area-inset-top, 0px))", borderBottom: `1px solid ${gray100}`, background: "white", flexShrink: 0, zIndex: 10 },
